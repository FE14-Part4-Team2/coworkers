      ...
      <AnimatePresence>
        {isVisible && message && (
          <motion.div
            ...
            onClick={hideToast}
            className={`fixed left-1/2 bottom-20 overflow-hidden pointer-events-auto pl-[3.5rem] pr-6 py-3 rounded-xl bg-bg-secondary text-lg z-[9999] max-w-[22.5rem] w-full flex items-center relative ${typeTextColor[type]}`}
          >
            <Icon type={type} />
