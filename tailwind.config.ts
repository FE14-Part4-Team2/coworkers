  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "landing-bottom-mobile": "url('/images/landing/landing-bottom-sm.png')",
        "landing-bottom-tablet": "url('/images/landing/landing-bottom-md.png')",
        "landing-bottom-pc": "url('/images/landing/landing-bottom-lg.png')",
      },
    },
  },
  plugins: [],
